/*
 * Modified by Amer Qouneh on: 15 October 2019
 * The original code used old dynamic directory names instead
 * of the new pwm-1:0, for example. Also, it used old names for duty_cycle
 * and enable.
 *
 *
